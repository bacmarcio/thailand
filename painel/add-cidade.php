...
<head>
    ...
    <title>Painel Hoogli - Adicionar Cidade</title>
            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-7 align-self-center">
                        <h4 class="page-title text-truncate text-dark font-weight-medium mb-1">Adicionar Cidade</h4>
                        ...
                        <div class="card">
                            <div class="card-body">
                                <form method="POST" enctype="multipart/form-data">
                                    ...
                                    <input type="hidden" name="acao" value="addCidade">
                                </form>
                            </div>
                        </div>
                    </div>
