...
<head>
    ...
    <title>Painel Hoogli - Adicionar Treinamento</title>
            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-7 align-self-center">
                        <h4 class="page-title text-truncate text-dark font-weight-medium mb-1">Adicionar Treinamento</h4>
...
<div class="col-md-12">	   
   ...
   <div class="form-group row">
	...
	<textarea name="meta_description" class="form-control" id="" cols="30" rows="10"></textarea> 
                                    ...
                                    <input type="hidden" name="acao" value="addTreinamento">
                                </form>
                            </div>
                        </div>
                    </div>
