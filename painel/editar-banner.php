                        ...
                        <div class="card">
                            <div class="card-body">
                                <form method="POST" enctype="multipart/form-data">
                                        ...
                                        <div class="row">
                                           <div class="col-md-6">
                                                ...
                                                <label class="mr-sm-2" for="">Imagem Mobile</label>
                                                    <input type="file" name="foto_mobile" class="form-control" >
                                                </div>
                                            </div>
                                            <?php if(isset($editarBanner->foto_mobile) && !empty($editarBanner->foto_mobile)){ ?>
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <img src="../img/<?php echo $editarBanner->foto_mobile;?>"  width="100">
                                                </div>
                                            </div>
                                            <?php }?>
                                        </div>
                                    ...
                                    <input type="hidden" name="foto_mobile_Atual" value="<?php if(isset($editarBanner->foto_mobile) && !empty($editarBanner->foto_mobile)){ echo $editarBanner->foto_mobile;}?>">
                                </form>
                            </div>
                        </div>
                    </div>
