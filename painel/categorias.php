            ...
            <div class="page-breadcrumb">
                <div class="row">
                    ...
                    <div class="col-5 align-self-center">
                        <a href="add-categoria.php" class="btn btn-success float-right">Add. Categoria</a>
                    </div>
                </div>
            </div>
                                    ...
                                    <table id="zero_config" class="table table-striped table-bordered no-wrap">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="editar-categoria.php?id=<?php echo $categoria->id;?>" class="btn btn-success btn-circle"><i class="fas fa-pencil-alt"></i></a>
                                                    <a href="categorias.php?id=<?php echo $categoria->id;?>&acao=excluirCategoria" class="btn btn-warning btn-circle"><i class="fa fa-times"></i></a>
                                                </td>
                                            </tr>
                                            <?php } }?>
                                        </tbody>
