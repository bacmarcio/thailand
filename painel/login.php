					...
					<div class="d-flex w-100 flex-center p-15">
						<div class="login-wrapper">
							...
							<div class="text-dark-75">
									...
									<img src="assets/images/img-background.jpg" width="100%" alt="" />
								...
								<br> <br>
								<small><p>©<?php echo date('Y');?> <?php echo $lang['PARA_EMBAIXADA']?> <?php echo $lang['DIREITOS']?></p></small>
							</div>
							<!--end:Aside Content-->
						</div>
					</div>
						...
						<div class="login-wrapper">
							...
							<div class="login-signin">
								<div class="text-center mb-10 mb-lg-20">
									<h2 class="font-weight-bold"><?php echo $lang['INFO']?></h2>
									<!-- <p class="text-muted font-weight-bold">Acesse para continuar.</p> -->
								</div>
								<form class="form text-left"  method="POST">
									<div class="form-group py-2 m-0">
										<input class="form-control h-auto border-0 px-3 placeholder-dark-75" type="text" placeholder="<?php echo $lang['EMAIL']?>" name="login" autocomplete="off" />
									</div>
									<div class="form-group py-2 border-top m-0">
										<input class="form-control h-auto border-0 px-3 placeholder-dark-75" type="Password" placeholder="<?php echo $lang['SENHA']?>" name="senha" />
									</div>
								...
								<div class="text-center mt-15">
										<button id="kt_login_signin_submit" class="btn btn-primary btn-pill shadow-sm py-4 px-9 font-weight-bold"><?php echo $lang['BTN_ACESSAR']?></button>
									</div>
								</form>
							</div>
							<!--end:Sign In Form-->
