            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-7 align-self-center">
                        <h4 class="page-title text-truncate text-dark font-weight-medium mb-1"><?php echo $lang['SOBRE_EMBAIXADA']?></h4>
                            ...
                            <div class="card-body">
                                <div class="table-responsive">
                                    <table id="zero_config" class="table table-striped table-bordered no-wrap">
                                        ...
                                        <tbody>
                                            <?php 
                                            if(count($puxaSobre) > 0){
                                            foreach($puxaSobre as $itemSobre){
                                                if($_SESSION['lang']=== 'en'){
