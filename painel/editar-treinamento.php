...
<head>
    ...
    <title>Painel Hoogli - Editar Treinamento</title>
            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-7 align-self-center">
                        <h4 class="page-title text-truncate text-dark font-weight-medium mb-1">Editar Treinamento</h4>
                        <div class="d-flex align-items-center">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb m-0 p-0">
                                    <li class="breadcrumb-item"><a href="." class="text-muted">Home</a></li>
                                    <li class="breadcrumb-item text-muted active" aria-current="page"><a href="treinamentos.php" class="text-muted">Treinamentos</a></li>
                                </ol>
                            </nav>
                        </div>
                    </div>
   ...
   <div class="row">
    <div class="col-md-3">
            ...
            <label class="mr-sm-2" for="">Embed</label>
                <input type="text" class="form-control" name="embed" value="<?php if(isset($editaTreinamento->embed) && !empty($editaTreinamento->embed)){ echo $editaTreinamento->embed;}?>" >
            </div>
        </div>
    </div>
   <div class="form-group row">
