            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-7 align-self-center">
                        <h4 class="page-title text-truncate text-dark font-weight-medium mb-1">Eventos</h4>
                            ...
                            <div class="card-body">
                                <div class="table-responsive">
                                    <table id="zero_config" class="table table-striped table-bordered no-wrap">
                                        ...
                                        <tbody>
                                            <?php 
                                            if(count($puxaEventos) > 0){
                                            foreach($puxaEventos as $puxaEventos){
                                                if($_SESSION['lang']=== 'en'){
                                                    $titulo = $puxaEventos->titulo_en;
                                                }
                                                elseif($_SESSION['lang']==='th') {
                                                    $titulo = $puxaEventos->titulo_th;
                                                }
                                                else
                                                {
                                                    $titulo = $puxaEventos->titulo;
                                                }

                                            ?>
                                            <tr>
                                                <td><?php echo $titulo;?></td>
                                                <td><?php echo formataData($puxaEventos->data);?></td>
