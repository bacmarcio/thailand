            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-7 align-self-center">
                        <h4 class="page-title text-truncate text-dark font-weight-medium mb-1"><?php echo $lang['SERVICO_CONSULAR']?></h4>
                                    ...
                                    <table id="zero_config" class="table table-striped table-bordered no-wrap">
                                        ...
                                        <tbody>
                                            ...
                                            foreach($puxaServicos as $servico){
                                                if($_SESSION['lang']=== 'en'){
                                                    $titulo = $servico->titulo_en;
                                                }
                                                elseif($_SESSION['lang']==='th') {
                                                    $titulo = $servico->titulo_th;
                                                }
                                                else
                                                {
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <a href="servicos.php?id=<?php echo $servico->id;?>&acao=excluirServico" class="btn btn-warning btn-circle"><i class="fa fa-times"></i></a>
                                                </td>
                                            </tr>
                                            <?php } }?>
                                        </tbody>
