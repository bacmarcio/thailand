                        ...
                        <div class="d-flex align-items-center">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb m-0 p-0">
                                    ...
                                    <li class="breadcrumb-item text-muted active" aria-current="page"><a href="eventos.php" class="text-muted">Eventos</a></li>
                                </ol>
                            </nav>
                        </div>
                    </div>
                        ...
                        <div class="card">
                            <div class="card-body">
                                <form method="POST" enctype="multipart/form-data">
                                    ...
                                    <input type="hidden" name="acao" value="addEventos">
                                </form>
                            </div>
                        </div>
                    </div>
