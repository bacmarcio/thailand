                        ...
                        <div class="card">
                            <div class="card-body">
                                <form method="POST" enctype="multipart/form-data">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <label class="mr-sm-2" for="">Título em Português</label>
                                                    <input type="text" class="form-control" name="titulo" value="<?php if(isset($editaSobre->titulo) && !empty($editaSobre->titulo)){ echo $editaSobre->titulo;}?>" >
                                                </div>
                                            </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                   ...
                                                   <textarea name="descricao" class="ckeditor" id="ckeditor" cols="30" rows="4"><?php if(isset($editaSobre->descricao) && !empty($editaSobre->descricao)){ echo $editaSobre->descricao;}?></textarea>
                                                </div>
                                            </div>                                        
                                        </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <label class="mr-sm-2" for="">Title in English</label>
                                                    <input type="text" class="form-control" name="titulo_en" value="<?php if(isset($editaSobre->titulo_en) && !empty($editaSobre->titulo_en)){ echo $editaSobre->titulo_en;}?>" >
                                                </div>
                                            </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                   ...
                                                   <textarea name="descricao_en" class="ckeditor" id="ckeditor" cols="30" rows="4"><?php if(isset($editaSobre->descricao_en) && !empty($editaSobre->descricao_en)){ echo $editaSobre->descricao_en;}?></textarea>
                                                </div>
                                            </div>                                        
                                        </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <label class="mr-sm-2" for="">ชื่อเรื่องภาษาไทย</label>
                                                    <input type="text" class="form-control" name="titulo_th" value="<?php if(isset($editaSobre->titulo_th) && !empty($editaSobre->titulo_th)){ echo $editaSobre->titulo_th;}?>" >
                                                </div>
                                            </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                   ...
                                                   <textarea name="descricao_th" class="ckeditor" id="ckeditor" cols="30" rows="4"><?php if(isset($editaSobre->descricao_th) && !empty($editaSobre->descricao_th)){ echo $editaSobre->descricao_th;}?></textarea>
                                                </div>
                                            </div>                                        
                                        </div>
                                    ...
                                    <input type="hidden" name="id" value="<?php echo $editaSobre->id;?>">
                                </form>
                            </div>
                        </div>
                    </div>
